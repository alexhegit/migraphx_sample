...
# keras models
#/usr/bin/python3 run_keras_model.py --model resnet50v1 --batch_size 64 --num_batches 100 
#/usr/bin/python3 run_keras_model.py --model resnet50v1 --batch_size 64 -k --num_batches 100
#/usr/bin/python3 run_keras_model.py --model resnet50v2 --batch_size 64 --num_batches 100 
#/usr/bin/python3 run_keras_model.py --model resnet50v2 --batch_size 64 -k --num_batches 100
#/usr/bin/python3 run_keras_model.py --model inceptionv3 --batch_size 32 --num_batches 100 
#/usr/bin/python3 run_keras_model.py --model inceptionv3 --batch_size 32 -k --num_batches 100
#/usr/bin/python3 run_keras_model.py --model vgg16 --batch_size 16 --num_batches 100 
#/usr/bin/python3 run_keras_model.py --model vgg16 --batch_size 16 -k --num_batches 100
#/usr/bin/python3 run_keras_model.py --model mobilenet --batch_size 64 --num_batches 100 
#/usr/bin/python3 run_keras_model.py --model mobilenet --batch_size 64 -k --num_batches 100
# resnet50v2
