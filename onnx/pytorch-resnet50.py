# script to download and save pytorch torchvision models for resnet50 to an
# ONNX file.
#
# Note: ONNX files for other torchvision models can also be created by
#       uncommenting the appropriate versions below.
import torch
